...
export const addMeal = ( meal, token ) => {
    return dispatch => {
        ...
        axiosMeals.post('/meals.json?auth=' + token, meal)
            .then(response => {
...
export const removeMeal = ( mealId, token ) => {
    return dispatch => {
        ...
        axiosMeals.delete('/meals/' + mealId + '.json?auth=' + token)
            .then(response => {
...
export const addIngredient = ( mealId, ingredient, token ) => {
    return dispatch => {
        ...
        axiosMeals.post('/meals/' + mealId + '/ingredients.json?auth=' + token, ingredient)
            .then(response => {
...
export const removeIngredient = ( mealId, ingredientId, token ) => {
    return dispatch => {
        ...
        axiosMeals.delete('/meals/' + mealId + '/ingredients/' + ingredientId + '.json?auth=' + token)
            .then(response => {
...
export const fetchMeals = (token, userId) => {
    return dispatch => {
        ...
        axiosMeals.get ('/meals.json' + queryParams)
            .then( response => {
                const fetchedMeals = [];
